...
const T: Record<DeviceType, (p: P) => React.ReactElement> = {
  ...
  hub: (p) => <S {...p}><path d="M8 6.3a1.7 1.7 0 1 0 0 3.4 1.7 1.7 0 0 0 0-3.4M8 6.3V3M8 9.7V13M6.3 8H3M9.7 8H13" /></S>,
  ...
  voip: (p) => <S {...p}><path d="M3 4c0 5 4 9 9 9l1.2-2.4-2.8-1.3-1.2 1.3A9 9 0 0 1 5.4 6.6L6.7 5.4 5.4 2.6 3 3.8z" /></S>,
  tablet: (p) => <S {...p}><path d="M3 2.5h10v11H3zM7 11.5h2" /></S>,
  ereader: (p) => <S {...p}><path d="M4 2.5h8v11H4zM4 2.5v11M6 5.5h4M6 8h3" /></S>,
  tv: (p) => <S {...p}><path d="M2 3.5h12v8H2zM6 14h4M6.5 3.5L8 2l1.5 1.5" /></S>,
  projector: (p) => <S {...p}><path d="M2 5.5h9v5H2zM11 6.7l3-1.2v5.4l-3-1.2M5 8a1.4 1.4 0 1 0 0-.1M12.5 3.5l-2 1.5" /></S>,
  media: (p) => <S {...p}><path d="M2 3.5h12v7H2zM4 13.5c0-2 1.5-3 4-3s4 1 4 3M8 6l3 1.7L8 9.4z" /></S>,
  display: (p) => <S {...p}><path d="M3 3h10v6.5H3zM5 13.5h6l-.7-3.5h-4.6z" /></S>,
  ...
  thermostat: (p) => <S {...p}><path d="M8 2.5a5.5 5.5 0 1 0 0 11 5.5 5.5 0 0 0 0-11M8 5.5a2.5 2.5 0 1 0 0 5 2.5 2.5 0 0 0 0-5M8 3.7v1.1" /></S>,
  appliance: (p) => <S {...p}><path d="M3.5 2h9v12h-9zM3.5 5.5h9M8 10a2.3 2.3 0 1 0 0-.1M5.4 3.7h.01M10.4 3.7h.01" /></S>,
  vacuum: (p) => <S {...p}><path d="M8 3.5a4.5 4.5 0 1 0 0 9 4.5 4.5 0 0 0 0-9M4 6.5h8M8 3.5v2M5.5 12.6l-.5 1.3M10.5 12.6l.5 1.3" /></S>,
  camera: (p) => <S {...p}><path d="M2 4.5l9-1.5v10L2 11.5zM11 6.5l3-1.5v6l-3-1.5" /></S>,
  doorbell: (p) => <S {...p}><path d="M5.5 2h5v12h-5zM8 5.3a1.2 1.2 0 1 0 0-.1M8 9.3a1.6 1.6 0 1 0 0-.1" /></S>,
